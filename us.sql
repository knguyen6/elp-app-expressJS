...
INSERT INTO userInfo (name, address, contact) VALUES ('user 1','Tacoma', 'xxxx@yy.com');
INSERT INTO userInfo (name, address, contact) VALUES ('user 2', 'Seattle', 'aaaa@bb.com');

INSERT INTO businessInfo (name, description) VALUES ('icicle','we freeze for eternitiy');
INSERT INTO businessInfo (name) VALUES ('YFC');
INSERT INTO businessInfo (name, description) VALUES ('Market-O-Food','we supply for all your house needs and yummy treats');

INSERT INTO business (businessInfoId, city, address, businessHours, averagePrice) VALUES (100001, 'Tacoma', 'commerece st', 'M-F 9-6', '$$');
INSERT INTO business (businessInfoId, city, address, businessHours, averagePrice) VALUES (100002, 'Tacoma', 'tacoma dome', 'M-S 9-10', '$');
INSERT INTO business (businessInfoId, city, address, businessHours, averagePrice) VALUES (100002, 'Seattle', 'pike', 'M-S 9-10', '$');
INSERT INTO business (businessInfoId, city, address, businessHours, averagePrice) VALUES (100003, 'Kent', '6th ave', 'M-S 9-10', '$');
INSERT INTO business (businessInfoId, city, address, businessHours, averagePrice) VALUES (100003, 'bellevue', '10th ave', 'M-S 9-10', '$');
...
INSERT INTO userRating (userId, businessId, rating) VALUES (10000001, 10000001, 4);
INSERT INTO userRating (userId, businessId, rating) VALUES (10000002, 10000002, 4);
INSERT INTO userRating (userId, businessId, rating) VALUES (10000001, 10000003, 3);
INSERT INTO userRating (userId, businessId, rating) VALUES (10000002, 10000002, 2);
INSERT INTO userRating (userId, businessId, rating) VALUES (10000001, 10000003, 5);
INSERT INTO userRating (userId, businessId, rating) VALUES (10000001, 10000004, 5);
INSERT INTO userRating (userId, businessId, rating) VALUES (10000002, 10000005, 3);

INSERT INTO userReview (userId, businessId, review) VALUES (10000001, 10000002, 'yum yum yum');
INSERT INTO userReview (userId, businessId, review) VALUES (10000001, 10000005, 'Lots of things but bad servie');
